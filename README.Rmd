...
The goal of r2dii.usethis is to automate package and project setup. It is inspired by the [usethis](https://usethis.r-lib.org/) package.
...
* [Getting help](https://github.com/2DegreesInvesting/r2dii.usethis/blob/master/.github/SUPPORT.md).
* [Contributing](https://github.com/2DegreesInvesting/r2dii.usethis/blob/master/.github/CONTRIBUTING.md).
* [Contributor Code of Conduct](https://github.com/2DegreesInvesting/r2dii.usethis/blob/master/.github/CODE_OF_CONDUCT.md).
