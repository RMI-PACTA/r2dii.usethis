...
* For private packages use `use_proprietary_license()`. For public packages
add a common license (see `?usethis::use_*_license()`).

```r
# Data packages should instead use CCO (https://r-pkgs.org/license.html)
use_mit_license()
```
